...
<head>
    <title>Select Task on Actor</title>
</head>

<body>
    <h1 align="center">Sakila</h1>
    <h2 align="center">Select Task on Actor</h2>
    <form method="get" > 
    <div class="middle">
    ...
    <h3>Search for Data from Actor Here:<h3>
        <form method = "POST">
        <select name="cond1">
    ...
    <?php
        if(isset($_POST['update'])){
            ...
            $update = sprintf("update actor set %s='%s',last_update=NOW() where actor_id = %s",$condition1,$condition3,$condition2);
    ...
    <?php
        if(isset($_POST['delete'])){
            ...
            $condition2 = $_POST['condition2'];
             ...
             //delete query
            $delete = sprintf("delete from actor where %s='%s'",$condition1,$condition2);
    ...
    <?php
        $cond1 = $_POST['cond1'];
        $cond2 = $_POST['cond2'];
        $search = sprintf("select actor_id, first_name, last_name, last_update FROM actor where %s='%s'",$cond1,$cond2);
